...
func (m *UserMutation) SetMoney(i int64) {
	m.money = &i
	m.addmoney = nil
}

// Money returns the money value in the mutation.
func (m *UserMutation) Money() (r int64, exists bool) {
	v := m.money
	if v == nil {
		return
	}
...
// OldMoney returns the old money value of the User.
// If the User object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *UserMutation) OldMoney(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldMoney is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddMoney adds i to money.
func (m *UserMutation) AddMoney(i int64) {
	if m.addmoney != nil {
		*m.addmoney += i
	} else {
		m.addmoney = &i
...
func (m *UserMutation) AddedMoney() (r int64, exists bool) {
	v := m.addmoney
	if v == nil {
		return
	}
...
// ResetMoney reset all changes of the "money" field.
...
// OldMeta returns the old meta value of the User.
// If the User object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
