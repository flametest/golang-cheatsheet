...
func (uc *UserCreate) SetMoney(i int64) *UserCreate {
	uc.mutation.SetMoney(i)
	return uc
}

// SetNillableMoney sets the money field if the given value is not nil.
func (uc *UserCreate) SetNillableMoney(i *int64) *UserCreate {
	if i != nil {
		uc.SetMoney(*i)
	}
	return uc
...
func (uc *UserCreate) SetMeta(jm json.RawMessage) *UserCreate {
	uc.mutation.SetMeta(jm)
	return uc
}
